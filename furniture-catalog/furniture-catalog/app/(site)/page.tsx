...
export default async function HomePage() {
  ...
  return (
    <div className="flex flex-col">
      {/* Hero */}
      <section className="container-wide grid gap-10 py-16 md:py-24 md:grid-cols-2 md:items-center">
      ...
      {/* Новинки */}
      {products.length > 0 && (
        <section className="container-wide py-12 md:py-16 border-t border-line">
